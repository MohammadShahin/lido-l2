...
import { L2BridgeExecutor } from "@aave/governance-crosschain-bridges/contracts/bridges/L2BridgeExecutor.sol";
...
contract MetisBridgeExecutor is L2BridgeExecutor {
  ...
  modifier onlyEthereumGovernanceExecutor() override {
    if (
      ...
      ICrossDomainMessengerMetis(L2_CROSS_DOMAIN_MESSENGER).xDomainMessageSender() !=
   ...
   * @dev Constructor
   *
   * @param l2CrossDomainMessenger The address of the Optimism L2CrossDomainMessenger
